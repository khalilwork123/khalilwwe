  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="container mx-auto px-6 py-16 max-w-4xl">
        <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-3xl font-bold mb-6">Contact Us</motion.h1>
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <form onSubmit={submit} className="bg-white rounded-lg shadow p-6 space-y-4">
            ...
            <div>
              ...
              <input value={form.contact} onChange={(e) => setForm({ ...form, contact: e.target.value })} className="w-full border rounded p-2" required />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Message</label>
              <textarea value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} className="w-full border rounded p-2 min-h-28" required />
            </div>
