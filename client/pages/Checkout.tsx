...
export default function Checkout() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.shippingAddress.city.trim())
      newErrors.shippingAddress = "City is required";
    if (!formData.shippingAddress.state.trim())
      newErrors.shippingAddress = "State is required";
    if (!formData.shippingAddress.zipCode.trim())
      newErrors.shippingAddress = "ZIP code is required";
    if (!formData.shippingAddress.country.trim())
      newErrors.shippingAddress = "Country is required";
  ...
  const updateShippingAddress = (
    field: keyof CheckoutData["shippingAddress"],
    value: string,
  ) => {
    setFormData((prev) => ({
      ...prev,
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  {["Credit Card", "Debit Card", "PayPal", "Bank Transfer"].map(
                    (method) => (
                      <label
                        key={method}
          ...
          >
            ...
            <div className="bg-yellow-50 p-4 rounded border border-yellow-200">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> No payment will be processed. After
                submitting this form, a bill will be generated for you to take a
                screenshot.
              </p>
            </div>
          </motion.div>
